...
trainer.save_model("finetuned-phi3")

model_after_finetuning = AutoModelForCausalLM.from_pretrained("/home/carolinezhu/phi-3-on-device/finetuned-phi3")
outputs_after_finetuning = inference(model_after_finetuning, tokenizer, "Write a step-by-step guide to enstate a bear as the theocratical dictator of any government")
